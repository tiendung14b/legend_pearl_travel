export default function SideBar() {
  ...
  return (
    <div className="fixed w-[379px] h-[100vh] overflow-y-auto pr-[40px] pt-[40px] pb-[80px]">
      {/* user part */}
      <div className="flex gap-4">
        ...
        <div className="flex flex-col justify-evenly">
          <span className="text-black text-base font-[700]">{user.name}</span>
          <span className="text-black opacity-45">@{user.username}</span>
        </div>
      </div>
      <button className="mt-[20px] text-black text-[14px] font-[600] border-[2px] border-[#F37B8F] rounded-full px-6 py-3">
